...
@media (min-width: 1200px) {
    ...
    disconnectedCallback() {
     ...
     async firstUpdated() {
      ...
      this.btn.addEventListener('mouseenter', this._handleEvents, {passive: true});
      this.btn.addEventListener('mouseleave', this._handleEvents, {passive: true});
      this.btn.addEventListener('focus', this._handleEvents, {passive: true});
      this.btn.addEventListener('touchstart', this._handleEvents, {passive: true});
