 ...
 */ const v = window.trustedTypes && trustedTypes.createPolicy("lit-html", {
    ...
    class N {
        ...
        commit() {
            ...
            o && this.element.removeEventListener(this.eventName, this.__boundHandleEvent, this.__options), n && (this.__options = L(t), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)), this.value = t, this.__pendingValue = h;
        }
        handleEvent(t) {
 ...
 */ );
    ...
    const O = new Map, P = new WeakMap, U = (t, o, n)=>{
        let r = P.get(o);
 ...
 */ class {
        handleAttributeExpressions(t, e, o, n) {
            ...
            if ("@" === r) return [
                new N(t, e.slice(1), n.eventContext)
            ];
            if ("?" === r) return [
                new M(t, e.slice(1), o)
            ];
...
*/ const X = window.ShadowRoot && (void 0 === window.ShadyCSS || window.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, K = Symbol();
    ...
    var it = {}, at = it && it.__spreadArray || function(t, e, o) {
    ...
    var lt = {}, st = lt && lt.__assign || function() {
    ...
    Object.defineProperty(lt, "__esModule", {
        value: !0
    }), lt.denormalize = lt.parse = void 0;
    var dt = {}, ct = dt && dt.__assign || function() {
        return ct = Object.assign || function(t) {
            for(var e, o = 1, n = arguments.length; o < n; o++)for(var r in e = arguments[o])Object.prototype.hasOwnProperty.call(e, r) && (t[r] = e[r]);
            return t;
        }, ct.apply(this, arguments);
    }, ft = dt && dt.__rest || function(t, e) {
        var o = {};
        for(var n in t)Object.prototype.hasOwnProperty.call(t, n) && e.indexOf(n) < 0 && (o[n] = t[n]);
        if (null != t && "function" == typeof Object.getOwnPropertySymbols) {
            var r = 0;
        ...
        return o;
    }, bt = dt && dt.__spreadArray || function(t, e) {
    ...
    dt.Linkset = ut;
    var mt = {}, gt = mt && mt.__rest || function(t, e) {
        var o = {};
        for(var n in t)Object.prototype.hasOwnProperty.call(t, n) && e.indexOf(n) < 0 && (o[n] = t[n]);
        if (null != t && "function" == typeof Object.getOwnPropertySymbols) {
            var r = 0;
    ...
    var ht = function(t) {
        var e = t.anchor, o = t.rel, n = t.href, r = gt(t, [
            "anchor",
            "rel",
            "href"
        ]);
    ...
    function xt(t) {
        ...
        return t.linkset.forEach(function(t) {
            var o = t.anchor, n = pt(t, [
                "anchor"
            ]);
            Object.keys(n).forEach(function(n) {
                t[n].forEach(function(t) {
                    e.push(new mt.Link(st({
                        anchor: o,
                        rel: n
                    }, t)));
                });
    ...
    mt.Link = ht, lt.denormalize = xt, lt.parse = function(t) {
        return xt(JSON.parse(t));
    };
    var wt = {}, vt = wt && wt.__spreadArray || function(t, e, o) {
        if (o || 2 === arguments.length) for(var n, r = 0, i = e.length; r < i; r++)!n && r in e || (n || (n = Array.prototype.slice.call(e, 0, r)), n[r] = e[r]);
        return t.concat(n || Array.prototype.slice.call(e));
    };
    Object.defineProperty(wt, "__esModule", {
        value: !0
    }), wt.buildTree = wt.hierarchyCompare = wt.MenuElement = void 0;
    var yt = function() {
        function t(t, e) {
            void 0 === e && (e = []), this.link = t, this.children = zt(vt([], e, !0));
        }
    ...
    function kt(t, e) {
        return 0 === t.length && 0 === e.length ? 0 : 0 === t.length && e.length > 0 ? -1 : t.length > 0 && 0 === e.length ? 1 : 1 === t.length && 1 === e.length ? parseInt(t[0]) - parseInt(e[0]) : t[0] === e[0] ? kt(t.slice(1), e.slice(1)) : parseInt(t[0]) - parseInt(e[0]);
    }
    function zt(t) {
        ...
        t.sort(function(t, e) {
            return kt(t.attributes.hierarchy, e.attributes.hierarchy);
        });
        var e, o = [], n = [];
        do {
            var r = t.shift();
            e ? r.attributes.hierarchy.length > e.attributes.hierarchy.length ? n.push(r) : (o.push(new yt(e, n)), e = r, n = []) : e = r;
        }while (t.length);
        return o.push(new yt(e, n)), o;
    }
    wt.MenuElement = yt, wt.hierarchyCompare = kt, wt.buildTree = zt;
    var St = function() {
        function t(t, e) {
            this.id = t, this.linkset = e, this.elements = this.linkset.elements, this.size = this.linkset.size, this.tree = (0, wt.buildTree)(at([], this.elements, !0));
        }
        return t.prototype[Symbol.iterator] = function() {
            ...
            var n = (0, lt.denormalize)(e), r = [];
            o ? r.push(o) : n.linksWithAttribute("machine-name").elements.forEach(function(t) {
                r.includes(t.attributes["machine-name"][0]) || r.push(t.attributes["machine-name"][0]);
            });
            var i = r.map(function(e) {
                return new t(e, n.linksWithAttributeValue("machine-name", e));
            });
            return o ? i.shift() : i;
        }, t;
    }();
    function _t(t, e) {
        return it.Menu.from(t, e);
    }
    it.Menu = St, rt.denormalize = _t, rt.parse = function(t, e) {
        return _t(JSON.parse(t), e);
    };
    const At = Symbol("tabindex"), Et = Symbol("oldTabindex"), Mt = Symbol("newTabindex"), Tt = (t)=>class extends t {
            ...
            set tabIndex(t) {
                const e = this[At];
                this[At] = t, this.requestUpdate("tabIndex", e);
            }
            firstUpdated() {
            ...
            update(t) {
                t.has("disabled") && this._disabledChanged(this.disabled, t.get("disabled")), t.has("tabIndex") && (this[Mt] = this.tabIndex, this._tabIndexChanged(this.tabIndex)), super.update(t);
            }
            updated(t) {
                super.updated(t), t.has("disabled") && (this.focusElement.disabled = this.disabled, this.disabled && this.blur()), t.has("tabIndex") && void 0 !== this[Mt] && (this.focusElement.tabIndex = this[Mt], this[Mt] = void 0);
            }
            get focusElement() {
            ...
            _disabledChanged(t, e) {
                t ? (this[Et] = this.tabIndex, this.tabIndex = -1, this.setAttribute("aria-disabled", "true")) : e && (void 0 !== this[Et] && (this.tabIndex = this[Et]), this.removeAttribute("aria-disabled"));
            }
            _tabIndexChanged(t) {
                this.disabled && t && (-1 !== this.tabIndex && (this[Et] = this.tabIndex), this.tabIndex = null);
            }
        };
    var jt = et`
    .button {
...
`;
    ...
    customElements.get("az-button") || customElements.define("az-button", Nt);
    class Lt extends nt {
        static get styles() {
            return et`
						:root {
    ...
    `;
      ...
      ${this.renderAzMenuLevel(e)}
        ...
        renderAzMenuItem(t) {
            ...
            let o = t?.link?.href;
            const n = t?.children, r = t?.link?.attributes?.hierarchy;
            let i = 0;
            i = r.length, console.log(i + " " + e);
            const a = o && "/" === o.charAt(0) ? `${this.thisUrl}${o}` : o;
            return n && n.length ? this.menuParentTemplate(e, n) : n && 0 === n.length && a && 1 === i ? Ot.azMenuTopLevelLinkTemplate(e, a) : a ? Ot.menuLinkTemplate(e, a) : Ot.menuItemTemplate(e);
        }
        constructor(){
            super(), this.tree = [], this.isLoading = !1, this.loadingMessage = "Loading...";
        }
   ...
   *,
   ...
   @media (min-width: 992px) {
    ...
    customElements.get("az-main-menu") || customElements.define("az-main-menu", Ot);
    Math.max, Math.min;
    var Bt = Math.round;
    function Dt() {
    ...
    function Gt(t, e, o) {
        ...
        e && Rt(t) && (r = t.offsetWidth > 0 && Bt(n.width) / t.offsetWidth || 1, i = t.offsetHeight > 0 && Bt(n.height) / t.offsetHeight || 1);
        var a = (Ut(t) ? Pt(t) : window).visualViewport, l = !!/^((?!chrome|android).)*safari/i.test(Dt()) && o, s = (n.left + (l && a ? a.offsetLeft : 0)) / r, p = (n.top + (l && a ? a.offsetTop : 0)) / i, d = n.width / r, c = n.height / i;
        return {
            width: d,
            height: c,
            top: p,
    ...
    function Zt(t) {
        return Gt(Ft(t)).left + Wt(t).scrollLeft;
    }
    function $t(t) {
        return Pt(t).getComputedStyle(t);
    }
    function Yt(t) {
        var e = $t(t), o = e.overflow, n = e.overflowX, r = e.overflowY;
        return /auto|scroll|overlay|hidden/.test(o + r + n);
    }
    function Jt(t, e, o) {
        void 0 === o && (o = !1);
        var n, r, i = Rt(e), a = Rt(e) && function(t) {
            var e = t.getBoundingClientRect(), o = Bt(e.width) / t.offsetWidth || 1, n = Bt(e.height) / t.offsetHeight || 1;
            return 1 !== o || 1 !== n;
        }(e), l = Ft(e), s = Gt(t, a, o), p = {
            scrollLeft: 0,
            scrollTop: 0
        }, d = {
            x: 0,
        ...
        return (i || !i && !o) && (("body" !== Ht(e) || Yt(l)) && (p = (n = e) !== Pt(n) && Rt(n) ? {
            scrollLeft: (r = n).scrollLeft,
            scrollTop: r.scrollTop
        } : Wt(n)), Rt(e) ? ((d = Gt(e, !0)).x += e.clientLeft, d.y += e.clientTop) : l && (d.x = Zt(l))), {
    ...
    function Qt(t) {
        return "html" === Ht(t) ? t : t.assignedSlot || t.parentNode || (Vt(t) ? t.host : null) || Ft(t);
    }
    function qt(t) {
        return [
            "html",
            "body",
            "#document"
        ].indexOf(Ht(t)) >= 0 ? t.ownerDocument.body : Rt(t) && Yt(t) ? t : qt(Qt(t));
    }
    function Xt(t, e) {
        var o;
        void 0 === e && (e = []);
        var n = qt(t), r = n === (null == (o = t.ownerDocument) ? void 0 : o.body), i = Pt(n), a = r ? [
            i
        ].concat(i.visualViewport || [], Yt(n) ? n : []) : n, l = e.concat(a);
        return r ? l : l.concat(Xt(Qt(a)));
    }
    function Kt(t) {
        return [
            "table",
    ...
    function te(t) {
        return Rt(t) && "fixed" !== $t(t).position ? t.offsetParent : null;
    }
    function ee(t) {
        for(var e = Pt(t), o = te(t); o && Kt(o) && "static" === $t(o).position;)o = te(o);
        return o && ("html" === Ht(o) || "body" === Ht(o) && "static" === $t(o).position) ? e : o || function(t) {
            var e = /firefox/i.test(Dt());
            if (/Trident/i.test(Dt()) && Rt(t) && "fixed" === $t(t).position) return null;
            var o = Qt(t);
            for(Vt(o) && (o = o.host); Rt(o) && [
                "html",
                "body"
            ].indexOf(Ht(o)) < 0;){
                var n = $t(o);
    ...
    var oe = "top", ne = "bottom", re = "right", ie = "left", ae = "start", le = "end", se = [
        "beforeRead",
        "read",
        "afterRead",
        "beforeMain",
    ...
    function ue(t) {
        void 0 === t && (t = {});
        var e = t, o = e.defaultModifiers, n = void 0 === o ? [] : o, r = e.defaultOptions, i = void 0 === r ? fe : r;
            ...
            var r, a, l = {
                ...
                setOptions: function(o) {
                    ...
                    c(), l.options = Object.assign({}, i, l.options, r), l.scrollParents = {
                        reference: Ut(t) ? Xt(t) : t.contextElement ? Xt(t.contextElement) : [],
                        popper: Xt(e)
                    };
                    var a = de(ce([].concat(n, l.options.modifiers)));
                ...
                forceUpdate: function() {
                    if (!p) {
                        ...
                        if (be(e, o)) {
                            var n, r, i, a;
                            l.rects = {
                                reference: Jt(e, ee(o), "fixed" === l.options.strategy),
                                popper: (n = o, r = Gt(n), i = n.offsetWidth, a = n.offsetHeight, Math.abs(r.width - i) <= 1 && (i = r.width), Math.abs(r.height - a) <= 1 && (a = r.height), {
                                    x: n.offsetLeft,
                                    y: n.offsetTop,
                                    width: i,
                                    height: a
    ...
    function we(t) {
        var e, o = t.reference, n = t.element, r = t.placement, i = r ? ge(r) : null, a = r ? he(r) : null, l = o.x + o.width / 2 - n.width / 2, s = o.y + o.height / 2 - n.height / 2;
        switch(i){
            case oe:
                e = {
                    x: l,
    ...
    function ye(t) {
        ...
        b = g.x, m = g.y;
        var h = a.hasOwnProperty("x"), x = a.hasOwnProperty("y"), w = ie, v = oe, y = window;
        if (p) {
            var k = ee(o), z = "clientHeight", S = "clientWidth";
            if (k === Pt(o) && "static" !== $t(k = Ft(o)).position && "absolute" === l && (z = "scrollHeight", S = "scrollWidth"), r === oe || (r === ie || r === re) && i === le) v = ne, m -= (c && k === y && y.visualViewport ? y.visualViewport.height : k[z]) - n.height, m *= s ? 1 : -1;
            if (r === ie || (r === oe || r === ne) && i === le) w = re, b -= (c && k === y && y.visualViewport ? y.visualViewport.width : k[S]) - n.width, b *= s ? 1 : -1;
        }
        var _, A = Object.assign({
            position: l
        }, p && ve), E = !0 === d ? function(t) {
        ...
        defaultModifiers: [
            {
                ...
                fn: function() {},
                effect: function(t) {
                    var e = t.state, o = t.instance, n = t.options, r = n.scroll, i = void 0 === r || r, a = n.resize, l = void 0 === a || a, s = Pt(e.elements.popper), p = [].concat(e.scrollParents.reference, e.scrollParents.popper);
                    return i && p.forEach(function(t) {
                        t.addEventListener("scroll", o.update, me);
                    }), l && s.addEventListener("resize", o.update, me), function() {
                        i && p.forEach(function(t) {
                            t.removeEventListener("scroll", o.update, me);
                        }), l && s.removeEventListener("resize", o.update, me);
                    };
                },
                data: {}
            },
            ...
            },
            {
                ...
                fn: function(t) {
                    ...
                    null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign({}, e.styles.popper, ye(Object.assign({}, p, {
                        offsets: e.modifiersData.popperOffsets,
                        position: e.options.strategy,
                        adaptive: a,
                        roundOffsets: s
                    })))), null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, ye(Object.assign({}, p, {
            ...
            },
            {
                ...
                fn: function(t) {
                    ...
                    Object.keys(e.elements).forEach(function(t) {
                        ...
                        Rt(r) && Ht(r) && (Object.assign(r.style, o), Object.keys(n).forEach(function(t) {
                            var e = n[t];
                ...
                effect: function(t) {
                    ...
                    return Object.assign(e.elements.popper.style, o.popper), e.styles = o, e.elements.arrow && Object.assign(e.elements.arrow.style, o.arrow), function() {
                        Object.keys(e.elements).forEach(function(t) {
                            ...
                            Rt(n) && Ht(n) && (Object.assign(n.style, i), Object.keys(r).forEach(function(t) {
                                n.removeAttribute(t);
                            }));
                        });
                    };
 ...
 */ /*! normalize.css v3.0.3 | MIT License | github.com/necolas/normalize.css */
        ...
        renderAzSelectMenuOptions(t) {
            const e = t.map((t)=>this.renderAzMenuItem(t));
            return ze.azMenuLevelTemplate(e);
        }
        renderAzMenuItem(t) {
            const e = t?.link?.attributes?.title;
            let o = t?.link?.href;
            return o = "/" === o.charAt(0) ? "https://www.arizona.edu" + o : o, o ? ze.azMenuOptionTemplate(e, o) : this.azMenuItemTemplate(e);
        }
        fetchData(t, e) {
            this.isLoading = !0;
            const o = `${t}/system/menu/${e}/linkset`;
        ...
        async firstUpdated() {
            await new Promise((t)=>setTimeout(t, 0)), this.btn = this.shadowRoot.querySelector("#button"), this.btn.addEventListener("click", this._handleEvents, {
                ...
                passive: !0
            }), this.form = this.shadowRoot.querySelector("form"), this.tooltip = this.shadowRoot.querySelector("#tooltip"), this.popperInstance = ke(this.form, this.tooltip, {
                placement: "top",
                modifiers: [
                    {
                        name: "offset",
    ...
    customElements.get("az-select-menu") || customElements.define("az-select-menu", ze);
