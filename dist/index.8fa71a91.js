...
`;
    ...
    class Ot extends nt {
        ...
        static azMenuTopLevelLinkTemplate(t, e) {
            return e = "/" === e.charAt(0) ? this.thisUrl + e : e, V`<li part="menu-item" class="nav-item">
			<a href=${e} class="nav-link">${t}</a>
		</li>`;
        }
        static menuLinkTemplate(t, e) {
            return e = "/" === e.charAt(0) ? this.thisUrl + e : e, V`<a
			part="menu-item"
			class="dropdown-item"
			href=${e}
			@click="${(t)=>{
        ...
        renderAzMenuItem(t) {
            const e = t?.link?.attributes?.title, o = t?.link?.href, n = t?.children, r = t?.link?.attributes?.["drupal-menu-hierarchy"];
            let i = 0;
            if (r && r.length > 0) {
                const t = r[0].match(/\./g);
                i = t ? t.length : 0;
