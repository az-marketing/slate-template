...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.MainMenu=void 0,require("regenerator-runtime/runtime");var e=require("lit-element"),t=require("linkset-menu");function n(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}class o extends e.LitElement{static get properties(){return{thisUrl:{type:String},data:{attribute:!1},baseUrl:{type:String},menuId:{type:String},branding:{type:String},tree:{type:Array},isLoading:{type:Boolean,attribute:!1},loadingMessage:{type:String}}}static menuLevelTemplate(t){return e.html`
      ${t}

    `}fetchData(e,n){this.isLoading=!0;const o=`${e}/system/menu/${n}/linkset`;fetch(o,{}).then(e=>{if(e.ok)return e.json();throw this.isLoading=!1,new Error(`Unable to fetch ${o}. ${e.status} ${e.statusText}`)}).then(e=>{try{const i=(0,t.denormalize)(e,n);this.tree=i.tree}catch(o){throw new Error("Unable to denormalize menu.")}this.isLoading=!1})}menuParentTemplate(t,n){return e.html`<li part="menu-item" class="nav-item menu-item--expanded dropdown nav-item nav-item-parent keep-open">
      <button
        @click="${o.openMenu}"
        role="button"
        aria-expanded="false"
   ...
   *,
   ...
   @media (min-width: 992px) {
       ...
       `}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.addEventListener("open-az-offcanvas-menu",this.handleOpen),await new Promise(e=>setTimeout(e,0)),this.addEventListener("close-az-offcanvas-menu",this.handleClose)}render(){return e.html`
            <div class="container">
...
},{"regenerator-runtime/runtime":"QVnC","lit-element":"bhxD","linkset-menu":"KH0w"}],"W8bA":[function(require,module,exports) {
