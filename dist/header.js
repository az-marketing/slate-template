...
`;const It=(t,e="")=>{window.dataLayer=window.dataLayer||[];var o=t.composedPath()[0],n=t.composedPath()[3].innerText?t.composedPath()[3].innerText.split("\n")[0]:"";window.dataLayer.push({event:"shadow_event_"+t.type,shadow_event:{elementInnerHTML:o.textContent||"",elementInnerText:o.innerText||"",title:"shadow-dom-link",element:o,elementClasses:o.className||"",elementId:o.id||"",elementLocation:e||"",elementTarget:o.target||"",elementUrl:o.href||o.action||"",originalEvent:t,parent:n||"",inShadowDom:!0}})};class Nt extends(Tt(nt)){static get properties(){return{link:{type:String,reflect:!0},target:{type:String,reflect:!0},toggle:{type:String,reflect:!0},event:{type:String,reflect:!0},elmid:{type:String,reflect:!0},value:{type:String,reflect:!0}}}static get styles(){return[jt]}constructor(){super()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o)}changeAttributes(){this.setAttribute("closed","true"),this.setAttribute("aria-expanded","true"),this.requestUpdate()}_handleClick(t){if(It(t,""),this.event){let t=new Event(this.event);document.querySelector(this.target).dispatchEvent(t)}else{let t=new Event("open-az-offcanvas-menu");document.querySelector(this.target).dispatchEvent(t)}}render(){return V`
    ...
    `}firstUpdated(){super.firstUpdated(),this.setAttribute("role","button")}get focusElement(){return this.shadowRoot.querySelector(".button")}}customElements.get("az-button")||customElements.define("az-button",Nt);class Lt extends nt{static get styles(){return et`
      ...
      <a href=${e} class="nav-link">${t}</a>
			...
			>${t}</a
		>`}static menuItemTemplate(t){return V`<li part="menu-item">${t}</li>`}renderAzMenuItem(t){const e=t?.link?.attributes?.title;let o=t?.link?.href;const n=t?.children,r=t?.link?.attributes?.hierarchy;let i=0;i=r.length,console.log(i+" "+e);const a=o&&"/"===o.charAt(0)?`${this.thisUrl}${o}`:o;return n&&n.length?this.menuParentTemplate(e,n):n&&0===n.length&&a&&1===i?Ot.azMenuTopLevelLinkTemplate(e,a):a?Ot.menuLinkTemplate(e,a):Ot.menuItemTemplate(e)}constructor(){super(),this.tree=[],this.isLoading=!1,this.loadingMessage="Loading..."}connectedCallback(){super.connectedCallback(),this.baseUrl&&this.menuId&&this.fetchData(this.baseUrl,this.menuId)}static get styles(){return et`
			:root {
				--blue: #0c234b;
				--red: #ab0520;
				--white: #fff;
