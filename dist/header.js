...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.AzButton=void 0;var e=require("lit-element"),t=require("./mixins/delegate-focus-mixin.js"),s=i(require("./styles/az-button-css.js"));function i(e){return e&&e.__esModule?e:{default:e}}class n extends((0,t.DelegateFocusMixin)(e.LitElement)){static get properties(){return{link:{type:String,reflect:!0},target:{type:String,reflect:!0},toggle:{type:String,reflect:!0},event:{type:String,reflect:!0},elmid:{type:String,reflect:!0},value:{type:String,reflect:!0}}}static get styles(){return[s.default]}constructor(){super()}attributeChangedCallback(e,t,s){super.attributeChangedCallback(e,t,s)}changeAttributes(){this.setAttribute("closed","true"),this.setAttribute("aria-expanded","true"),this.requestUpdate()}_handleClick(e){if(this.event){let e=new Event(this.event);document.querySelector(this.target).dispatchEvent(e)}else{let e=new Event("open-az-offcanvas-menu");document.querySelector(this.target).dispatchEvent(e),console.log(this)}}trackClicks(e){window.dataLayer=window.dataLayer||[];var t=e.composedPath()[0];window.dataLayer.push({event:"shadow_event_"+e.type,shadow_event:{elementInnerHTML:t.innerHTML.replace("\n","").replace("\x3c!----\x3e","").replace("<slot></slot>","").trim()||"",elementInnerText:t.innerText||"",title:"shadow-dom-link",element:t,elementId:t.id||"",elementClasses:t.className||"",elementUrl:t.href||t.action||"",elementTarget:t.target||"",originalEvent:e,inShadowDom:!0}})}render(){return e.html`
