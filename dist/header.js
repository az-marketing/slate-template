...
"use strict";function e(e){e.preventDefault(),window.dataLayer=window.dataLayer||[];var t=e.composedPath()[0],n=e.composedPath()[3];window.dataLayer.push({event:"shadow_event_"+e.type,shadow_event:{elementInnerHTML:t.textContent||"",elementInnerText:t.innerText||"",title:"shadow-dom-link",element:t,elementId:t.id||"",elementClasses:t.className||"",elementUrl:t.href||t.action||"",elementTarget:t.target||"",originalEvent:e,parentDropdown:n.innerText.split("\n")[0]||"",inShadowDom:!0}}),console.log(window.dataLayer)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.eventDataLayerPush=e;
