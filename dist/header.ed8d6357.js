...
parcelRequire = function (e, r, t, n) {
  ...
  "ffYV": [function (require, module, exports) {
    "use strict";
    ...
    var n = function () {
      ...
      return n.prototype.hasLinkTo = function (t) {
        return this.elements.some(function (e) {
          return e.rel === t;
        });
      }, n.prototype.linkTo = function (t) {
        return this.elements.find(function (e) {
          return e.rel === t;
        });
      }, n.prototype.linksTo = function (t) {
        return new n(this.elements.filter(function (e) {
          return e.rel === t;
        }));
      }, n.prototype.linksFrom = function (t) {
        return new n(this.elements.filter(function (e) {
          return e.anchor === t;
        }));
      }, n.prototype.linksWithAttribute = function (t) {
        return new n(this.elements.filter(function (e) {
          return Object.prototype.hasOwnProperty.call(e.attributes, t);
        }));
      }, n.prototype.linksWithAttributeValue = function (t, e) {
        return new n(this.linksWithAttribute(t).elements.filter(function (r) {
          return (Array.isArray(r.attributes[t]) ? r.attributes[t] : [r.attributes[t]]).some(function (t) {
            return o(t, e);
          });
        }));
        ...
        return this.elements.forEach(function (r) {
          var o = r.anchor,
              i = r.rel,
              u = e(r, ["anchor", "rel"]);
          Object.hasOwnProperty.call(n, o) || (n[o] = {}), Object.hasOwnProperty.call(n[o], i) || (n[o][i] = []);
          var s = u.href,
              l = u.attributes,
              a = t({
            href: s
          ...
          linkset: Object.entries(n).reduce(function (e, n) {
            var o = n[0],
                i = n[1];
            return r(r([], e), [t({
              anchor: o
    ...
    function o(t, e) {
      return typeof t == typeof e && ("string" == typeof t && "string" == typeof e ? t === e : t.value == t.value && t.language == t.language);
    }
  ...
  "a6pp": [function (require, module, exports) {
    ...
    var e = this && this.__spreadArray || function (e, t) {
    ...
    var t = function () {
      function t(t, n) {
        void 0 === n && (n = []), this.link = t, this.children = r(e([], n));
      }
    ...
    function r(e) {
      if (e.length < 2) return e.length ? [new t(e.shift())] : [];
      e.sort(function (e, t) {
        return e.attributes["drupal-menu-hierarchy"][0].localeCompare(t.attributes["drupal-menu-hierarchy"][0]);
      });
      var r,
          n = [],
          i = [];
      ...
      do {
        var u = e.shift();
        r ? u.attributes["drupal-menu-hierarchy"][0].length > r.attributes["drupal-menu-hierarchy"][0].length ? i.push(u) : (n.push(new t(r, i)), r = u, i = []) : r = u;
      } while (e.length);

      return n.push(new t(r, i)), n;
    }

    exports.MenuElement = t, exports.buildTree = r;
  }, {}],
  "yD3y": [function (require, module, exports) {
    ...
    var t = this && this.__extends || function () {
      ...
      return function (e, r) {
        ...
        e = this && this.__spreadArray || function (t, e) {
      for (var r = 0, n = e.length, o = t.length; r < n; r++, o++) t[o] = e[r];
    ...
    var r = require("linkset/dist/core/linkset"),
        n = require("./menu-element"),
        o = function (r) {
      function o(t, o) {
        var i = r.call(this, o.elements) || this;
        return i.id = t, i.tree = n.buildTree(e([], i.elements)), i;
      }

      return t(o, r), o.prototype.linksTo = function (t) {
        return new o(this.id, r.prototype.linksTo.call(this, t));
      }, o.prototype.linksFrom = function (t) {
        return new o(this.id, r.prototype.linksTo.call(this, t));
      }, o.prototype.linksWithAttribute = function (t) {
        return new o(this.id, r.prototype.linksWithAttribute.call(this, t));
      }, o.prototype.linksWithAttributeValue = function (t, e) {
        return new o(this.id, r.prototype.linksWithAttributeValue.call(this, t, e));
      }, o;
    }(r.Linkset);

    exports.Menu = o;
  }, {
    "linkset/dist/core/linkset": "ffYV",
    "./menu-element": "a6pp"
  }],
  "PN4H": [function (require, module, exports) {
    "use strict";

    var r = this && this.__rest || function (r, e) {
      var t = {};
      ...
      if (null != r && "function" == typeof Object.getOwnPropertySymbols) {
        ...
        for (o = Object.getOwnPropertySymbols(r); n < o.length; n++) e.indexOf(o[n]) < 0 && Object.prototype.propertyIsEnumerable.call(r, o[n]) && (t[o[n]] = r[o[n]]);
      }
    ...
    var e = function () {
      return function (e) {
        var t = e.anchor,
            o = e.rel,
            n = e.href,
            i = r(e, ["anchor", "rel", "href"]);
        this.anchor = t, this.rel = o, this.href = n, this.attributes = i;
      };
    }();
  ...
  "rkQ2": [function (require, module, exports) {
    ...
    var t = require("./core/linkset"),
        n = require("./core/link");

    function o(o) {
      var i = [];
      return o.linkset.forEach(function (t) {
        var o = t.anchor,
            s = e(t, ["anchor"]);
    ...
    exports.denormalize = o, exports.parse = i;
  }, {
    "./core/linkset": "ffYV",
    "./core/link": "PN4H"
  }],
  "KH0w": [function (require, module, exports) {
    "use strict";
    ...
    var e = require("./core/menu"),
        r = require("linkset");

    function n(n, t) {
      var u = r.denormalize(n),
          a = [];
      t ? a.push(t) : u.linksWithAttribute("drupal-menu-machine-name").elements.forEach(function (e) {
        a.includes(e.attributes["drupal-menu-machine-name"][0]) || a.push(e.attributes["drupal-menu-machine-name"][0]);
      });
      var i = a.map(function (r) {
        return new e.Menu(r, u.linksWithAttributeValue("drupal-menu-machine-name", r));
      });
      return t ? i.shift() : i;
    }

    function t(e, r) {
      return n(JSON.parse(e), r);
    }

    exports.denormalize = n, exports.parse = t;
  }, {
    "./core/menu": "yD3y",
    "linkset": "rkQ2"
  }],
  "Ktcg": [function (require, module, exports) {
    "use strict";
    ...
    const t = Symbol("tabindex"),
          e = Symbol("oldTabindex"),
          s = Symbol("newTabindex"),
          i = i => class extends i {
      ...
      set tabIndex(e) {
        const s = this[t];
        this[t] = e, this.requestUpdate("tabIndex", s);
      }
      ...
      update(t) {
        t.has("disabled") && this._disabledChanged(this.disabled, t.get("disabled")), t.has("tabIndex") && (this[s] = this.tabIndex, this._tabIndexChanged(this.tabIndex)), super.update(t);
      }

      updated(t) {
        super.updated(t), t.has("disabled") && (this.focusElement.disabled = this.disabled, this.disabled && this.blur()), t.has("tabIndex") && void 0 !== this[s] && (this.focusElement.tabIndex = this[s], this[s] = void 0);
      }
      ...
      _disabledChanged(t, s) {
        t ? (this[e] = this.tabIndex, this.tabIndex = -1, this.setAttribute("aria-disabled", "true")) : s && (void 0 !== this[e] && (this.tabIndex = this[e]), this.removeAttribute("aria-disabled"));
      }

      _tabIndexChanged(t) {
        this.disabled && t && (-1 !== this.tabIndex && (this[e] = this.tabIndex), this.tabIndex = null);
      }

    };

    exports.DelegateFocusMixin = i;
  }, {}],
...
`;
  ...
  "EM68": [function (require, module, exports) {
    ...
    class o extends e.LitElement {
      ...
      renderAzMenuItem(e) {
        var t, r, i;
        const n = null == e ? void 0 : null === (t = e.link) || void 0 === t ? void 0 : null === (r = t.attributes) || void 0 === r ? void 0 : r.title;
        let a = null == e ? void 0 : null === (i = e.link) || void 0 === i ? void 0 : i.href;
        const s = null == e ? void 0 : e.children;
        return a = "/" === a.charAt(0) ? this.thisUrl + a : a, s.length ? this.azMenuParentTemplate(n, s) : a ? o.azMenuLinkTemplate(n, a) : o.azMenuItemTemplate(n);
      }

      fetchData(e, o) {
        this.isLoading = !0;
        const r = `${e}/system/menu/${o}/linkset`;
        fetch(r, {}).then(e => {
          if (e.ok) return e.json();
          throw this.isLoading = !1, new Error(`Unable to fetch ${r}. ${e.status} ${e.statusText}`);
        }).then(e => {
          try {
            const i = (0, t.denormalize)(e, o);
            this.tree = i.tree;
          } catch (r) {
  ...
  "MlEP": [function (require, module, exports) {
    ...
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.MainMenu = void 0, require("regenerator-runtime/runtime");
    ...
    `;
      ...
      fetchData(e, n) {
        this.isLoading = !0;
        const o = `${e}/system/menu/${n}/linkset`;
        fetch(o, {}).then(e => {
          if (e.ok) return e.json();
          throw this.isLoading = !1, new Error(`Unable to fetch ${o}. ${e.status} ${e.statusText}`);
        }).then(e => {
          try {
            const i = (0, t.denormalize)(e, n);
            this.tree = i.tree;
          } catch (o) {
            throw new Error("Unable to denormalize menu.");
          }
      ...
      menuParentTemplate(t, n) {
        return e.html`<li part="menu-item" class="nav-item menu-item--expanded dropdown nav-item nav-item-parent keep-open">
      <button
        @click="${o.openMenu}"
        role="button"
        aria-expanded="false"
      ...
      static openMenu(e) {
        ...
        let n = document.querySelector("az-main-menu").shadowRoot.querySelector(".nav-item.show button");
        "true" === t.getAttribute("aria-expanded") ? (t.parentElement.classList.remove("show"), t.setAttribute("aria-expanded", "false"), t.nextElementSibling.classList.remove("show")) : (n && (n.parentElement.classList.remove("show"), n.setAttribute("aria-expanded", "false"), n.nextElementSibling.classList.remove("show")), t.parentElement.classList.add("show"), t.setAttribute("aria-expanded", "true"), t.nextElementSibling.classList.add("show"));
      }
      ...
      static azMenuTopLevelLinkTemplate(t, n) {
        return n = "/" === n.charAt(0) ? this.thisUrl + n : n, e.html`<li part="menu-item" class="nav-item"><a href=${n} class="nav-link">${t}</a></li>`;
      }

      static menuLinkTemplate(t, n) {
        return n = "/" === n.charAt(0) ? this.thisUrl + n : n, e.html`<a part="menu-item" class="dropdown-item" href=${n}>${t}</a>`;
      }

      static menuItemTemplate(t) {
        return e.html`<li part="menu-item">${t}</li>`;
      }
   ...
   *,
   ...
   @media (min-width: 992px) {
      ...
      async firstUpdated() {
        await new Promise(e => setTimeout(e, 0)), this.addEventListener("open-az-offcanvas-menu", this.handleOpen), await new Promise(e => setTimeout(e, 0)), this.addEventListener("close-az-offcanvas-menu", this.handleClose);
      }
                    ...
                    <section class="region region-navigation">
                        <nav role="navigation" aria-labelledby="block-az-barrio-main-menu-menu" id="block-az-barrio-main-menu" class="block block-menu navigation menu--main">
                            ...
                            <ul block="block-az-barrio-main-menu" class="clearfix navbar-nav flex-lg-row">
                                ${this.isLoading ? e.html`<li part="menu-item" class="nav-item menu-item--expanded dropdown nav-item nav-item-parent keep-open">
  ...
  "uy7N": [function (require, module, exports) {
    "use strict";
  ...
  "Cbix": [function (require, module, exports) {
    ...
    "./getWindowScroll.js": "oJ75",
    "./getWindow.js": "QiNa",
    "./instanceOf.js": "wsKO",
    "./getHTMLElementScroll.js": "uy7N"
  }],
  ...
  "zwcJ": [function (require, module, exports) {
    "use strict";
  ...
  "j3Hf": [function (require, module, exports) {
    "use strict";
  ...
  "FCaM": [function (require, module, exports) {
    "use strict";
    ...
    "./getBoundingClientRect.js": "W8bA",
    "./getNodeScroll.js": "Cbix",
    "./getNodeName.js": "B1zX",
    "./instanceOf.js": "wsKO",
    "./getWindowScrollBarX.js": "zwcJ",
    "./getDocumentElement.js": "sJcE",
    "./isScrollParent.js": "j3Hf"
  }],
  ...
  "IVKl": [function (require, module, exports) {
    "use strict";
  ...
  "Qnrt": [function (require, module, exports) {
    "use strict";
    ...
    "./getParentNode.js": "IVKl",
    "./isScrollParent.js": "j3Hf",
    "./getNodeName.js": "B1zX",
    "./instanceOf.js": "wsKO"
  }],
  "m3DJ": [function (require, module, exports) {
    "use strict";
    ...
    "./getScrollParent.js": "Qnrt",
    "./getParentNode.js": "IVKl",
    "./getWindow.js": "QiNa",
    "./isScrollParent.js": "j3Hf"
  }],
  "rK11": [function (require, module, exports) {
    "use strict";
  ...
  "CUhI": [function (require, module, exports) {
    "use strict";
  ...
  "mGsv": [function (require, module, exports) {
    "use strict";
  ...
  "AjzX": [function (require, module, exports) {
    "use strict";
  ...
  "rB0G": [function (require, module, exports) {
    "use strict";
  ...
  "M7BJ": [function (require, module, exports) {
    ...
    "../enums.js": "XHUo",
    "./getViewportRect.js": "E2lw",
    "./getDocumentRect.js": "yEje",
    "./listScrollParents.js": "m3DJ",
    "./getOffsetParent.js": "CUhI",
    "./getDocumentElement.js": "sJcE",
    "./getComputedStyle.js": "S6rb",
    "./instanceOf.js": "wsKO",
    "./getBoundingClientRect.js": "W8bA",
    ...
    "./contains.js": "x3Ja",
    "./getNodeName.js": "B1zX",
    "../utils/rectToClientRect.js": "rB0G",
    "../utils/math.js": "FuL6"
  }],
  "auH8": [function (require, module, exports) {
    "use strict";
  ...
  "dvfD": [function (require, module, exports) {
    ...
    "./getBasePlacement.js": "QS9h",
    "./getVariation.js": "auH8",
    "./getMainAxisFromPlacement.js": "PMyK",
    "../enums.js": "XHUo"
  }],
  ...
  "sYkG": [function (require, module, exports) {
    "use strict";
  ...
  "Moke": [function (require, module, exports) {
    ...
    "../enums.js": "XHUo",
    "../dom-utils/instanceOf.js": "wsKO",
    "./mergePaddingObject.js": "SCz0",
    "./expandToHashMap.js": "sYkG"
  }],
  "rg1d": [function (require, module, exports) {
    ...
    "./dom-utils/getCompositeRect.js": "FCaM",
    "./dom-utils/getLayoutRect.js": "wDsK",
    "./dom-utils/listScrollParents.js": "m3DJ",
    "./dom-utils/getOffsetParent.js": "CUhI",
    "./dom-utils/getComputedStyle.js": "S6rb",
    "./utils/orderModifiers.js": "mxvt",
    "./utils/debounce.js": "mGsv",
    "./utils/validateModifiers.js": "nr2q",
    "./utils/uniqueBy.js": "AjzX",
    "./utils/getBasePlacement.js": "QS9h",
    "./utils/mergeByName.js": "pDli",
    "./utils/detectOverflow.js": "Moke",
    "./dom-utils/instanceOf.js": "wsKO",
    "./enums.js": "XHUo"
  }],
  "psGJ": [function (require, module, exports) {
    "use strict";
  ...
  "D2nT": [function (require, module, exports) {
    ...
    "../dom-utils/getNodeName.js": "B1zX",
    "../dom-utils/instanceOf.js": "wsKO"
  }],
  "hwU4": [function (require, module, exports) {
    "use strict";
    ...
    "./createPopper.js": "rg1d",
    "./modifiers/eventListeners.js": "psGJ",
    "./modifiers/popperOffsets.js": "Pf8x",
    "./modifiers/computeStyles.js": "ebtt",
    "./modifiers/applyStyles.js": "D2nT"
  }],
  "zu08": [function (require, module, exports) {
    "use strict";
...
@media (min-width: 1200px) {
    ...
    .left-buffer-lg-30 {
      ...
      constructor() {
        super(), r(this, "_showTooltip", () => {
          ...
          } else switch (this.select.setAttribute("aria-invalid", "false"), this.btn.classList.remove("disabled"), o.type) {
            case "click":
              this._hideTooltip(), o.stopImmediatePropagation(), window.location = t;
          }
        }), this.tree = [], this.isLoading = !1, this.loadingMessage = "Loading...";
      }
      ...
      fetchData(o, t) {
        this.isLoading = !0;
        const r = `${o}/system/menu/${t}/linkset`;
        fetch(r, {}).then(o => {
          if (o.ok) return o.json();
          throw this.isLoading = !1, new Error(`Unable to fetch ${r}. ${o.status} ${o.statusText}`);
        }).then(o => {
          try {
            const i = (0, e.denormalize)(o, t);
            this.tree = i.tree;
          } catch (r) {
            throw new Error("Unable to denormalize menu.");
          }
      ...
      async firstUpdated() {
        await new Promise(o => setTimeout(o, 0)), this.btn = this.shadowRoot.querySelector("#button"), this.btn.addEventListener("click", this._handleEvents, {
          passive: !0
          ...
          passive: !0
        }), this.form = this.shadowRoot.querySelector("form"), this.tooltip = this.shadowRoot.querySelector("#tooltip"), this.popperInstance = (0, t.createPopper)(this.form, this.tooltip, {
          placement: "top",
          modifiers: [{
            name: "offset",
            options: {
  ...
  "GiDN": [function (require, module, exports) {
    ...
    require("./az-button"), require("./az-select-menu");
  ...
  "cJDT": [function (require, module, exports) {
    ...
    var e = require("./az-redbar"),
        r = require("./az-main-menu"),
        a = require("./az-middle-header");
  }, {
    "./az-redbar": "EM68",
    "./az-main-menu": "MlEP",
