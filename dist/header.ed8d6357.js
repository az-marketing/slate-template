...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dist/header.js":[function(require,module,exports) {
(() => {
  /**
   * @license
  ...
  const z = t => null === t || !("object" == typeof t || "function" == typeof t),
  ...
  class _ {
    ...
    _getValue() {
      ...
      for (let r = 0; r < e; r++) {
        ...
        if (void 0 !== e) {
          const t = e.value;
          if (z(t) || !S(t)) n += "string" == typeof t ? t : String(t);else for (const e of t) n += "string" == typeof e ? e : String(e);
        }
      }
      return n += t[e], n;
    }
  ...
  class E {
    ...
    __commitText(t) {
      const e = this.startNode.nextSibling,
        o = "string" == typeof (t = null == t ? "" : t) ? t : String(t);
    ...
    __commitTemplateResult(t) {
      ...
      if (this.value instanceof w && this.value.template === e) this.value.update(t.values);else {
        const o = new w(e, t.processor, this.options),
          n = o._clone();
  ...
  class I {
    ...
    commit() {
      ...
      const t = this.__pendingValue,
        e = this.value,
        o = null == t || null != e && (t.capture !== e.capture || t.once !== e.once || t.passive !== e.passive),
        n = null != t && (null == e || o);
  ...
  class {
    handleAttributeExpressions(t, e, o, n) {
      const r = e[0];
      if ("." === r) {
        return new T(t, e.slice(1), o).parts;
      }
      if ("@" === r) return [new I(t, e.slice(1), n.eventContext)];
      if ("?" === r) return [new M(t, e.slice(1), o)];
  ...
  const G = t => e => {
    ...
    F = (t, e, o) => {
      ...
      if (window.ShadyCSS.nativeShadow && null !== s) e.insertBefore(s.cloneNode(!0), e.firstChild);else if (o) {
  ...
  class Q extends HTMLElement {
    ...
    static createProperty(t) {
      let e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Y;
    ...
    _propertyToAttribute(t, e) {
      let o = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Y;
      const n = this.constructor,
        r = n._attributeNameForProperty(t, o);
      if (void 0 !== r) {
    ...
    _attributeToProperty(t, e) {
      ...
      const o = this.constructor,
        n = o._attributeToPropertyMap.get(t);
      if (void 0 !== n) {
  ...
  */
  ...
  class nt extends Q {
    ...
    static _getUniqueStyles() {
      ...
      if (Array.isArray(t)) {
        const e = (t, o) => t.reduceRight((t, o) => Array.isArray(o) ? e(o, t) : (t.add(o), t), o),
          o = e(t, new Set()),
          n = [];
  ...
  nt.finalized = !0, nt.render = (t, o, n) => {
    ...
    const r = n.scopeName,
      i = P.has(o),
      a = D && 11 === o.nodeType && !!o.host,
      l = a && !H.has(r),
      s = l ? document.createDocumentFragment() : o;
  ...
  var it,
    at = {},
    lt = at && at.__extends || (it = function (t, e) {
  ...
  var bt = function () {
    ...
    return t.prototype.hasLinkTo = function (t) {
      ...
      return new t(this.linksWithAttribute(e).elements.filter(function (t) {
        return (Array.isArray(t.attributes[e]) ? t.attributes[e] : [t.attributes[e]]).some(function (t) {
  ...
  pt.Linkset = bt;
  var ut = {},
    mt = ut && ut.__spreadArray || function (t, e) {
      for (var o = 0, n = e.length, r = t.length; o < n; o++, r++) t[r] = e[o];
      return t;
    };
  ...
  function ht(t) {
    if (t.length < 2) return t.length ? [new gt(t.shift())] : [];
    t.sort(function (t, e) {
  ...
  const Et = Symbol("tabindex"),
    Mt = Symbol("oldTabindex"),
    Tt = Symbol("newTabindex"),
    jt = t => class extends t {
...
`;
  const It = function (t) {
    ...
    var o = t.composedPath()[0],
      n = t.composedPath()[3].innerText ? t.composedPath()[3].innerText.split("\n")[0] : "";
  ...
  class Ct extends nt {
    ...
    renderAzMenuItem(t) {
      let e = t && t.link && t.link.attributes && t.link.attributes.title,
        o = t && t.link && t.link.href,
        n = t && t.children;
  ...
  function Wt(t, e, o) {
    ...
    var a = (Rt(t) ? Ut(t) : window).visualViewport,
      l = !!/^((?!chrome|android).)*safari/i.test(Gt()) && o,
      s = (n.left + (l && a ? a.offsetLeft : 0)) / r,
      p = (n.top + (l && a ? a.offsetTop : 0)) / i,
      d = n.width / r,
      c = n.height / i;
    return {
      width: d,
    ...
    var n,
      ...
      a = Vt(e) && function (t) {
        var e = t.getBoundingClientRect(),
          o = Dt(e.width) / t.offsetWidth || 1,
          n = Dt(e.height) / t.offsetHeight || 1;
        return 1 !== o || 1 !== n;
      }(e),
      l = Zt(e),
      s = Wt(t, a, o),
  ...
  function Xt(t) {
    return ["html", "body", "#document"].indexOf(Ft(t)) >= 0 ? t.ownerDocument.body : Vt(t) && Jt(t) ? t : Xt(qt(t));
  }
  function Kt(t, e) {
    var o;
    void 0 === e && (e = []);
    var n = Xt(t),
      r = n === (null == (o = t.ownerDocument) ? void 0 : o.body),
      i = Ut(n),
      a = r ? [i].concat(i.visualViewport || [], Jt(n) ? n : []) : n,
      l = e.concat(a);
  ...
  function oe(t) {
    ...
    return o && ("html" === Ft(o) || "body" === Ft(o) && "static" === Yt(o).position) ? e : o || function (t) {
      ...
      var o = qt(t);
      for (Bt(o) && (o = o.host); Vt(o) && ["html", "body"].indexOf(Ft(o)) < 0;) {
        var n = Yt(o);
