								...
								<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 py-0">
									<div id="block-bean-uaqs-footer-links-bean-main" class="block block-bean first odd small text-right-lg text-right-md  text-right-sm text-center-xs" role="complementary">
										<ul class="menu top-menu">
											...
											<li class="menu__item is-leaf leaf"><a href="https://cirt.arizona.edu" title="" class="menu__link" @click="${e=>{se(e,"az-footer")}}">Emergency Information</a></li>
											...
											<li class="menu__item is-leaf leaf"><a href="https://safety.arizona.edu/" title="" class="menu__link" @click="${e=>{se(e,"az-footer")}}">Campus Safety</a></li>
					...
					<div id="footer_sub" class="region region-footer-sub">
							...
							<div class="row">
									<div id="block-bean-uaqs-footer-links-bean-information" class="block block-bean first odd col-xs-12 col-sm-6 col-md-3 col-lg-3" role="complementary">
										...
										<ul class="menu menu-bottom">
											<li class="menu__item is-leaf first leaf"><a href="https://www.arizona.edu/admissions" class="menu__link" @click="${e=>{se(e,"az-footer")}}">Future Students</a></li>
											...
											<li class="menu__item is-leaf last leaf"><a href="https://corporate.arizona.edu/" title="" class="menu__link" @click="${e=>{se(e,"az-footer")}}">Corporations &amp; Businesses</a></li>
										</ul>
									</div>
									...
									<div id="block-bean-uaqs-footer-links-bean-topics" class="block block-bean even col-xs-12 col-sm-6 col-md-5" role="complementary">
										...
										<ul class="menu menu-bottom topic-menu">
											...
											<li class="menu__item is-leaf leaf"><a href="https://diversity.arizona.edu" class="menu__link" @click="${e=>{se(e,"az-footer")}}">Diversity</a></li>
											...
											<li class="menu__item is-leaf leaf"><a href="https://international.arizona.edu" class="menu__link" @click="${e=>{se(e,"az-footer")}}">International Engagement</a></li>
											...
											<li class="menu__item is-leaf leaf"><a href="https://uaforyou.arizona.edu" class="menu__link" @click="${e=>{se(e,"az-footer")}}">Outreach &amp; Extension</a></li>
											<li class="menu__item is-leaf leaf"><a href="https://research.arizona.edu" class="menu__link" @click="${e=>{se(e,"az-footer")}}">Research &amp; Innovation</a></li>
									...
									<div id="block-bean-uaqs-footer-links-bean-resources" class="block block-bean odd col-xs-12 col-sm-6 col-md-2 clearfix" role="complementary">
										...
										<ul class="menu menu-bottom"><li class="menu__item is-leaf first leaf"><a href="https://directory.arizona.edu/index" class="menu__link" @click="${e=>{se(e,"az-footer")}}"><i class="ua-brand-directory"></i>A-Z Index</a></li>
											...
											<li class="menu__item is-leaf leaf"><a href="https://map.arizona.edu" class="menu__link" @click="${e=>{se(e,"az-footer")}}"><i class="ua-brand-campus-map"></i>Campus Map</a></li>
											...
											<li class="menu__item is-leaf leaf"><a href="https://directory.arizona.edu/phonebook" class="menu__link" @click="${e=>{se(e,"az-footer")}}"><i class="ua-brand-directory"></i>Phonebook</a></li>
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								...
								<p class="copyright small">© <span><script>document.write( new Date().getFullYear() );</script></span> The Arizona Board of Regents on behalf of <a href="https://www.arizona.edu" target="_blank" @click="${e=>{se(e,"az-footer")}}">The University of Arizona</a>.</p>
							</div>
						</div>
					</div>
				</div>
