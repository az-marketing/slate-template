						...
						<div class="container">
							<div class="row">
									...
									<div id="block-bean-uaqs-footer-links-bean-resources" class="block block-bean odd col-xs-12 col-sm-6 col-md-2 clearfix" role="complementary">
										...
										<ul class="menu menu-bottom"><li class="menu__item is-leaf first leaf"><a href="https://directory.arizona.edu/index" class="menu__link" @click="${e=>{ne(e,"az-footer")}}"><i class="ua-brand-directory"></i>A-Z Index</a></li>
											...
											<li class="menu__item is-leaf leaf"><a href="https://directory.arizona.edu/phonebook" class="menu__link" @click="${e=>{ne(e,"az-footer")}}"><i class="ua-brand-directory"></i>Phonebook</a></li>
