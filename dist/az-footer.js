					...
					<div id="footer_sub" class="region region-footer-sub">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								...
								<p class="copyright small">© <span>${(new Date).getFullYear()}</span> The Arizona Board of Regents on behalf of <a href="https://www.arizona.edu" target="_blank" @click="${e=>{se(e,"az-footer")}}">The University of Arizona</a>.</p>
							</div>
						</div>
					</div>
				</div>
