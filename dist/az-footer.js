				...
				<div class="region region-footer">
					...
					>
						<div class="row">
							...
							<div class="page-row-padding-top page-row-padding-bottom"></div>
							<div
								class="col-12 col-sm-4 col-md-4 col-lg-4 text-center text-sm-start"
							>
								<div class="row px-0">
									<div class="col-12">
										<a
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-8 py-0">
								<div
									id="block-bean-uaqs-footer-links-bean-main"
									class="block block-bean first odd small text-lg-end text-md-end text-sm-end text-center"
									role="complementary"
								>
					...
					<div class="container">
						<div class="row">
							<div
								...
								class="block block-bean first odd col-12 col-sm-6 col-md-3 col-lg-3"
								role="complementary"
							>
							...
							<div
								...
								class="block block-bean even col-12 col-sm-6 col-md-5"
								role="complementary"
							>
							...
							<div class="d-none d-sm-block d-md-none col-12">
								<hr />
							</div>
							<div
								id="block-bean-uaqs-footer-links-bean-resources"
								class="block block-bean odd col-12 col-sm-6 col-md-2 clearfix"
								role="complementary"
							>
							...
							<div
								...
								class="block block-bean even col-12 col-sm-6 col-md-2 clearfix"
								role="complementary"
							>
