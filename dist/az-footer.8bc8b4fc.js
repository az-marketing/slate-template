...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dist/az-footer.js":[function(require,module,exports) {
(() => {
  /**
   * @license
    ...
    constructor(e, t) {
      ...
      for (; p < u;) {
        ...
        if (null !== e) {
          ...
          } else if (8 === e.nodeType) if (e.data === i) {
            const t = e.parentNode;
            null !== e.previousSibling && m !== f || (m++, t.insertBefore(c(), e)), f = m, this.parts.push({
              type: "node",
              index: m
            }), null === e.nextSibling ? e.data = "" : (o.push(e), m--), p++;
          } else {
            let t = -1;
            for (; -1 !== (t = e.data.indexOf(i, t + 1));) this.parts.push({
              type: "node",
              index: -1
            }), p++;
          }
  ...
  class z {
    ...
    _getValue() {
      ...
      for (let s = 0; s < t; s++) {
        ...
        if (void 0 !== t) {
          const e = t.value;
          if (k(e) || !S(e)) o += "string" == typeof e ? e : String(e);else for (const t of e) o += "string" == typeof t ? t : String(t);
        }
      }
      return o += e[t], o;
    }
  ...
  class P {
    ...
    commit() {
      ...
      const e = this.__pendingValue;
      e !== b && (k(e) ? e !== this.value && this.__commitText(e) : e instanceof v ? this.__commitTemplateResult(e) : e instanceof Node ? this.__commitNode(e) : S(e) ? this.__commitIterable(e) : e === x ? (this.value = x, this.clear()) : this.__commitText(e));
    }
    __insert(e) {
    ...
    __commitTemplateResult(e) {
      ...
      if (this.value instanceof _ && this.value.template === t) this.value.update(e.values);else {
        const i = new _(t, e.processor, this.options),
          o = i._clone();
    ...
    clear() {
      let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.startNode;
  ...
  class $ {
    ...
    commit() {
      ...
      const e = this.__pendingValue,
        ...
        o = null != e && (null == t || i);
      i && this.element.removeEventListener(this.eventName, this.__boundHandleEvent, this.__options), o && (this.__options = U(e), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)), this.value = e, this.__pendingValue = b;
    }
    handleEvent(e) {
  ...
  class {
    handleAttributeExpressions(e, t, i, o) {
      const s = t[0];
      if ("." === s) {
        return new T(e, t.slice(1), i).parts;
      }
      if ("@" === s) return [new $(e, t.slice(1), o.eventContext)];
      if ("?" === s) return [new N(e, t.slice(1), i)];
  ...
  const H = e => t => {
    ...
    W = (e, t, i) => {
      ...
      if (window.ShadyCSS.nativeShadow && null !== l) t.insertBefore(l.cloneNode(!0), t.firstChild);else if (i) {
  ...
  class X extends HTMLElement {
    ...
    static _valueHasChanged(e, t) {
      let i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : J;
      return i(e, t);
    }
    static _propertyValueFromAttribute(e, t) {
      const i = t.type,
        o = t.converter || D,
        s = "function" == typeof o ? o : o.fromAttribute;
      return s ? s(e, i) : e;
    }
    ...
    _propertyToAttribute(e, t) {
      let i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Y;
      const o = this.constructor,
        s = o._attributeNameForProperty(e, i);
      if (void 0 !== s) {
    ...
    _attributeToProperty(e, t) {
      ...
      const i = this.constructor,
        o = i._attributeToPropertyMap.get(e);
      if (void 0 !== o) {
  ...
  */
  ...
  const se = function (e) {
    ...
    var i = e.composedPath()[0],
      o = e.composedPath()[3].innerText ? e.composedPath()[3].innerText.split("\n")[0] : "";
